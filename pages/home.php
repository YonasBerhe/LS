...
<section id="action" class="bg-1 altcolor" data-speed="6" data-type="background">
    <!-- Begin trailer content -->
    <div class="container">
        <div class=" substyle text-center">
            <br>
            <h1>Join our Beta!</h1>
            <br>
...
<div class= "container">
      ...
      <div class="col-md-3 col-md-4 text-center centerup ">
       ...
       <div class="item"><a href="http://www.imedicalapps.com/2014/01/design-video-games-health-insights-rwj-foundation-award-winning-litesprite" target="_blank"><img class="logopix img-responsive" src="./images/imedicalapps.png" alt="iMedical Apps"/></a></div>
       <div class="item"><a href="http://www.entrepreneurship.org/en/ID8/Seattle/DRIVERS/Too-Big-for-Their-Britches.aspx" target="_blank"><img class="logopix img-responsive" src="./images/kauffman.png" alt="Kauffman Foundation"/></a></div>
       <div class="item"><a href="http://www.marketplace.org/topics/tech/breaking-through-competitive-app-market" target="_blank"><img class="logopix img-responsive" src="./images/marketplace.png" alt="Marketplace"/></a></div>
       <div class="item"><a href="http://www.geekwire.com/2013/meet-class-win-reactor-interactive-media-accelerator" target="_blank"><img class="logopix img-responsive" src="./images/geekwire.png" alt="geekwire"/></a></div>
       <div class="item"><a href="http://www.medgadget.com/2013/07/behavioral-health-a-big-focus-at-games-for-health-conference.html" target="_blank"><img class="logopix img-responsive" src="./images/medgadget.png" alt="MedGadget"/></a></div>
       <div class="item"><a href="http://www.women2.com/female-founders-to-watch-seattle-edition" target="_blank"><img class="logopix img-responsive" src="./images/women20.png" alt="Women 2.0"/></a></div>
       <div class="item"><a href="http://www.geekwire.com/2013/litesprite" target="_blank"><img class="logopix img-responsive" src="./images/geekwire.png" alt="geekwire"/></a></div>
