...
$report_data1 .= <<<EOD
	<tr>
		<td class="left" style="width: 120px;"><a href="/rpt_pmph_one/{$client_key}">{$client_key}</a></td><td>{$pmph4}</td>
	</tr>
EOD;
		}
	}	
    ...
    <div class="colmask fullpage">
        <div class="col1 center">
            ...
            <div class="reporting">
				<table  width="600px">
					<tr>
	                    <td colspan="2" class="titlerow">Have you ever received any psychiatric<br/>or psychological treatment?<span class="titlenote"><a href="/rpt_pmph_sum/{$survey_id}">(View Summary Report)</a></span></td>
	                </tr>
					<tr>
